...
export interface InfiniteSearchableSelectOption {
  label: string
  value: string
...
interface InfiniteSearchableSelectProps {
  options: InfiniteSearchableSelectOption[]
  value?: string
...
export function InfiniteSearchableSelect({
  ...
  const setCurrentSearchValue = onSearchChange ? onSearchChange : setInternalSearchValue
  ...
  }, [open, setCurrentSearchValue])

  // Handle infinite scroll
  const handleScroll = useCallback(() => {
    if (!listRef.current || !onLoadMore || !hasNextPage || isFetchingNextPage) return
